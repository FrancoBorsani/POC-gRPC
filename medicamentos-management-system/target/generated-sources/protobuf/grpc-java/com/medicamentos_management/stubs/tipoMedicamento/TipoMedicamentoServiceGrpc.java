...
public final class TipoMedicamentoServiceGrpc {
  ...
  public static final String SERVICE_NAME = "com.medicamentos_management.stubs.tipoMedicamento.TipoMedicamentoService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.medicamentos_management.stubs.tipoMedicamento.TipoMedicamentoRequest,
      com.medicamentos_management.stubs.tipoMedicamento.TipoMedicamentoResponse> getAltaTipoMedicamentoMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "altaTipoMedicamento",
      requestType = com.medicamentos_management.stubs.tipoMedicamento.TipoMedicamentoRequest.class,
      responseType = com.medicamentos_management.stubs.tipoMedicamento.TipoMedicamentoResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.medicamentos_management.stubs.tipoMedicamento.TipoMedicamentoRequest,
      com.medicamentos_management.stubs.tipoMedicamento.TipoMedicamentoResponse> getAltaTipoMedicamentoMethod() {
    io.grpc.MethodDescriptor<com.medicamentos_management.stubs.tipoMedicamento.TipoMedicamentoRequest, com.medicamentos_management.stubs.tipoMedicamento.TipoMedicamentoResponse> getAltaTipoMedicamentoMethod;
      ...
      synchronized (TipoMedicamentoServiceGrpc.class) {
        if ((getAltaTipoMedicamentoMethod = TipoMedicamentoServiceGrpc.getAltaTipoMedicamentoMethod) == null) {
          TipoMedicamentoServiceGrpc.getAltaTipoMedicamentoMethod = getAltaTipoMedicamentoMethod =
              io.grpc.MethodDescriptor.<com.medicamentos_management.stubs.tipoMedicamento.TipoMedicamentoRequest, com.medicamentos_management.stubs.tipoMedicamento.TipoMedicamentoResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "altaTipoMedicamento"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.medicamentos_management.stubs.tipoMedicamento.TipoMedicamentoRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.medicamentos_management.stubs.tipoMedicamento.TipoMedicamentoResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.medicamentos_management.stubs.tipoMedicamento.TipoMedicamentoRequest,
      com.medicamentos_management.stubs.tipoMedicamento.TipoMedicamentoResponse> getGetTipoMedicamentoInfoMethod;
  ...
  public static io.grpc.MethodDescriptor<com.medicamentos_management.stubs.tipoMedicamento.TipoMedicamentoRequest,
      com.medicamentos_management.stubs.tipoMedicamento.TipoMedicamentoResponse> getGetTipoMedicamentoInfoMethod() {
    io.grpc.MethodDescriptor<com.medicamentos_management.stubs.tipoMedicamento.TipoMedicamentoRequest, com.medicamentos_management.stubs.tipoMedicamento.TipoMedicamentoResponse> getGetTipoMedicamentoInfoMethod;
  ...
  public static abstract class TipoMedicamentoServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void altaTipoMedicamento(com.medicamentos_management.stubs.tipoMedicamento.TipoMedicamentoRequest request,
    ...
    /**
     */
    public void getTipoMedicamentoInfo(com.medicamentos_management.stubs.tipoMedicamento.TipoMedicamentoRequest request,
        io.grpc.stub.StreamObserver<com.medicamentos_management.stubs.tipoMedicamento.TipoMedicamentoResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.medicamentos_management.stubs.tipoMedicamento.TipoMedicamentoRequest,
                com.medicamentos_management.stubs.tipoMedicamento.TipoMedicamentoResponse>(
  ...
  public static final class TipoMedicamentoServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<TipoMedicamentoServiceBlockingStub> {
    ...
    /**
     */
    public com.medicamentos_management.stubs.tipoMedicamento.TipoMedicamentoResponse altaTipoMedicamento(com.medicamentos_management.stubs.tipoMedicamento.TipoMedicamentoRequest request) {
    ...
    /**
     */
    public com.medicamentos_management.stubs.tipoMedicamento.TipoMedicamentoResponse getTipoMedicamentoInfo(com.medicamentos_management.stubs.tipoMedicamento.TipoMedicamentoRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class TipoMedicamentoServiceFutureStub extends io.grpc.stub.AbstractFutureStub<TipoMedicamentoServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.medicamentos_management.stubs.tipoMedicamento.TipoMedicamentoResponse> altaTipoMedicamento(
        com.medicamentos_management.stubs.tipoMedicamento.TipoMedicamentoRequest request) {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.medicamentos_management.stubs.tipoMedicamento.TipoMedicamentoResponse> getTipoMedicamentoInfo(
        com.medicamentos_management.stubs.tipoMedicamento.TipoMedicamentoRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_ALTA_TIPO_MEDICAMENTO:
          serviceImpl.altaTipoMedicamento((com.medicamentos_management.stubs.tipoMedicamento.TipoMedicamentoRequest) request,
              (io.grpc.stub.StreamObserver<com.medicamentos_management.stubs.tipoMedicamento.TipoMedicamentoResponse>) responseObserver);
          break;
  ...
  private static abstract class TipoMedicamentoServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.medicamentos_management.stubs.tipoMedicamento.TipoMedicamento.getDescriptor();
    }
